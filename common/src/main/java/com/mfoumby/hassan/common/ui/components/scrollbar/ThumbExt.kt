package com.mfoumby.hassan.common.ui.components.scrollbar
 ...
 */
@Composable
internal fun LazyListState.rememberDraggableScroller(
    itemsAvailable: Int,
 ...
 */
@Composable
internal fun LazyGridState.rememberDraggableScroller(
    itemsAvailable: Int,
): (Float) -> Unit = rememberDraggableScroller(
    itemsAvailable = itemsAvailable,
    scroll = ::scrollToItem,
