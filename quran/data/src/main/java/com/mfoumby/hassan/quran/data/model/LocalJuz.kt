...
@DatabaseView(
    ...
    value = """
        SELECT 
            ${VerseField.Local.VERSE_JUZ_NUMBER} AS $JUZ_NUMBER,
            ...
            V.${VerseField.Local.VERSE_JUZ_NUMBER} AS ${JUZ_FIRST_VERSE}_${VerseField.Local.VERSE_JUZ_NUMBER},
            V.${VerseField.Local.VERSE_HIZB_NUMBER} AS ${JUZ_FIRST_VERSE}_${VerseField.Local.VERSE_HIZB_NUMBER},
        ...
        INNER JOIN (
            SELECT ${VerseField.Local.VERSE_JUZ_NUMBER} AS JUZ, MIN(${VerseField.Local.VERSE_SURAH_NUMBER}) AS SURAH_NUMBER
            FROM $VERSE_TABLE_NAME
            GROUP BY ${VerseField.Local.VERSE_JUZ_NUMBER}
        ) FIRST_SURAH
        ON V.${VerseField.Local.VERSE_JUZ_NUMBER} = FIRST_SURAH.JUZ 
        ...
        WHERE V.${VerseField.Local.VERSE_NUMBER} = (
            ...
            WHERE V2.${VerseField.Local.VERSE_JUZ_NUMBER} = V.${VerseField.Local.VERSE_JUZ_NUMBER}
